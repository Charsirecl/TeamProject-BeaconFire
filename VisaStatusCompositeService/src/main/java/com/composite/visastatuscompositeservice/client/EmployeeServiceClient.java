...
@FeignClient(name = "EmployeeService", url = "http://localhost:8080") // Replace with your EmployeeService URL
public interface EmployeeServiceClient {

    @PutMapping("EmployeeService/api/employees/personalDocument/{employeeId}")
    ...
    @PutMapping("EmployeeService/api/employees/visaStatus/{employeeId}")
